    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getSupportActionBar()!=null){
            ...
            if(Build.VERSION.SDK_INT>Build.VERSION_CODES.M){
                color = new ColorDrawable(getColor(R.color.hospital_color));
                getWindow().setStatusBarColor(getColor(R.color.hospital_color));
            }else{
                color = new ColorDrawable(getResources().getColor(R.color.hospital_color));
            }
